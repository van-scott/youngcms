package com.esen.youngcms.core.utils.redis;
...
public class JedisClient { 
	 ...
	 public void init() {
            ...
            //redis如果设置了密码：
            jedisPool = new JedisPool(config,addresses,port,10000,password);   
	}
	...
	public class Lists {
		...
		public List<String> brpop(int timeout, String key) {
			Jedis sjedis = getJedis();   
			List<String> list = sjedis.brpop(timeout, key);
			returnJedis(sjedis);
			return list;
		}
	...
	public static void main(String[] args) {
		JedisClient jedisUtil= JedisClient.getInstance();  
		JedisClient.Strings strings=jedisUtil.new Strings();
		...
		JedisClient.getInstance().returnJedis(jedis);   
	}
